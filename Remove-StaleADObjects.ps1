$inactiveCompsOU = "OU=Computer Accounts,OU=Termed Accounts,DC=peppermillcas,DC=com"
$inactiveUsersOU = "OU=User Accounts,OU=Termed Accounts,DC=peppermillcas,DC=com"
$todayDate = Get-Date
