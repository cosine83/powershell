...
$FromAddress = "wsusdecline@domain.com"
$Recipients = "you@domain.com"
$MessageSubject = "WSUS :: Declining Itanium and ARM64 Updates"
...
$itanium = $WsusServerAdminProxy.GetUpdates() | ?{-not $_.IsDeclined -and $_.Title -match “ia64|itanium|arm64”}
If ($TrialRun)
